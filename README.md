...
**Version 1.9.1** - Latest Release

A comprehensive desktop application for managing dog breeding operations, built with Tauri, React, TypeScript, and SQLite.

> **New in 1.9.1**: Bug reporting to GitHub Issues, Excel export for expenses. See [CHANGELOG.md](CHANGELOG.md) for the latest updates.
