...
> **New in 1.6.0**: Complete contract generation overhaul with new template format, dual Word/PDF output, and comprehensive test coverage. See [CHANGELOG.md](CHANGELOG.md) for details.
